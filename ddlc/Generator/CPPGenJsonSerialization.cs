...
namespace ddlc
{
    public static class CPPGenJsonSerialization
    {
        ...
        public static void WriteStructJsonSerialization(string tab, StructDecl decl, List<StructDecl> Structs, StringBuilder sb)
        {
        ...
        public static void WriteStructJsonSerialization(string tab, ClassDecl decl, List<ClassDecl> Structs, StringBuilder sb)
        {
            var nspace = Utils.BuildNamespace(decl);
            sb.AppendFormat(tab + "std::string {0}::to_json(const {0} * self)\n", nspace);
            sb.AppendLine(tab + "{");
        ...
        private static string buildSubobjectSerialization(string tab, ClassDecl decl, string parentJson, string self,
        ...
        private static string buildSubobjectSerialization(string tab, StructDecl decl, string parentJson, string self,
        ...
        private static string buildStructFieldJsonSerialization(string tab, AggregateField m, string obj, string self,
            List<ClassDecl> Structs, int nestLevel)
        {
